            ...
            <div className="flex gap-4 justify-center items-center">
              ...
              <form>
                ...
                <div class="hidden lg:block relative">
                  ...
                  <button
                    type="submit"
                    class="text-white absolute right-2.5 bottom-1.5 bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-0.5 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                  >
                    Search
                  </button>
                </div>
