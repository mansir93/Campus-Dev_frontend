              ...
              <div className="grid items-center lg:grid-cols-2 lg:gap-x-12">
                <div className="my-12 lg:mt-0">
                  ...
                  <p className="text-neutral-600 dark:text-neutral-200">
                    Welcome to Student Hub, the ultimate online destination for
                    students. Whether you're pursuing higher education,
                    preparing for exams, or looking to connect with like-minded
                    individuals, we've got you covered.
                  </p>
                </div>
